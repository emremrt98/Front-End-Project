...
alert("Mod : Kolay Seviye\nGörev : 1 - 25 arasında toplamda 3 hakkı harcamadan doğru sayıyı bulmak.");
...
let hak = 3;
const sayiUret = Math.floor((Math.random() * 25) + 1);
...
buton = buton.addEventListener("click", function (e) {
    ...
    if (girilenDeger > 25 || girilenDeger <= 0) {
        alert("Lütfen 1 - 25 arasında tahminler de bulun. Kuralları bilmiyorsan 'Yardım' menüsünden öğrenebilirsin");
